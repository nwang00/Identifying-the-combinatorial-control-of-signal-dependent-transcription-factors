...
P1_GRN1_fit_raw<-function(t, state, parameters) {
  ...
  G <- (t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,])*(t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,])*(t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,])/((parameters["Kd1"]+t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,])*(parameters["Kd2"]+t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,])*(parameters["Kd3"]+t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,]))
  # ptint(c(G,state))
...
P1_GRN2_fit_raw<-function(t, state, parameters) {
  ...
  G<-(1-parameters["Kd1"]*parameters["Kd2"]*parameters["Kd3"]/((parameters["Kd1"]+(t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,]))*(parameters["Kd2"]+(t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,]))*(parameters["Kd3"]+(t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,]))))
...
P1_GRN3_fit_raw<-function(t, state, parameters) {
  ...
  G<-1-(parameters["Kd1"]/(parameters["Kd1"]+t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,]))*(1-(t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,])*(t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,])/((parameters["Kd2"]+t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,])*(parameters["Kd3"]+t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,])))
...
P1_GRN4_fit_raw<-function(t, state, parameters) {
  ...
  G<-((t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,])/(parameters["Kd1"]+t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,]))*(1-parameters["Kd2"]*parameters["Kd3"]/((parameters["Kd2"]+(t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,]))*(parameters["Kd3"]+(t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,]))))
...
P1_GRN5_fit_raw<-function(t, state, parameters) {
  ...
  G<-1-(parameters["Kd2"]/(parameters["Kd2"]+t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,]))*(1-(t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,])*(t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,])/((parameters["Kd1"]+t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,])*(parameters["Kd3"]+t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,])))
...
P1_GRN6_fit_raw<-function(t, state, parameters) {
  ...
  G<-((t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,])/(parameters["Kd2"]+t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,]))*(1-parameters["Kd1"]*parameters["Kd3"]/((parameters["Kd1"]+(t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,]))*(parameters["Kd3"]+(t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,]))))
...
P1_GRN7_fit_raw<-function(t, state, parameters) {
  ...
  G<-1-(parameters["Kd3"]/(parameters["Kd3"]+t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,]))*(1-(t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,])*(t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,])/((parameters["Kd1"]+t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,])*(parameters["Kd2"]+t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,])))
...
P1_GRN8_fit_raw<-function(t, state, parameters) {
  ...
  G<-((t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,])/(parameters["Kd3"]+t_a_f*TF3_act[t_f+1,]+(1-t_a_f)*TF3_act[t_f,]))*(1-parameters["Kd1"]*parameters["Kd2"]/((parameters["Kd1"]+(t_a_f*TF1_act[t_f+1,]+(1-t_a_f)*TF1_act[t_f,]))*(parameters["Kd2"]+(t_a_f*TF2_act[t_f+1,]+(1-t_a_f)*TF2_act[t_f,]))))
