...
########################################
# pdf("Exp_fitting_together.pdf",width=6,height=170)
# pheatmap(log2(data_fit_order+0.01),cellheight=8, cellwidth = 3,gaps_row = seq(9,dim(data_fit_list)[1],9),gaps_col = seq(4,16,4),
#          legend=T,
#          show_rownames = T,show_colnames = F,cluster_cols = F,cluster_rows = F,font_size=0.1,
#          annotation_row = annotation_row_order,annotation_legend = F, annotation_names_row = F,annotation_colors = anno_colors)
# graphics.off()
########################################
annotation_row_order_thre<-annotation_row_order
annotation_row_order_thre[which(annotation_row_order_thre[,1]<fit_threshold),1]<-0
annotation_row_order_thre[which(annotation_row_order_thre[,1]>=fit_threshold),1]<-1

# pdf("Exp_fitting_together_thre.pdf",width=6,height=170)
# pheatmap(log2(data_fit_order+0.01),cellheight=8, cellwidth = 3,gaps_row = seq(9,dim(data_fit_list)[1],9),gaps_col = seq(4,16,4),
#          legend=T,
#          show_rownames = T,show_colnames = F,cluster_cols = F,cluster_rows = F,font_size=0.1,
#          annotation_row = annotation_row_order_thre,annotation_legend = F, annotation_names_row = F,annotation_colors = anno_colors)
# graphics.off()
################################################################################
