...
MAP_TV_estimate<-function(data.raw,caRNA_Slope_Full_list,var_trend_g,var_trend_n,sd_coeff){
  # data.raw<-caRNA_raw_bio_V0.01_BT50_rep1000
  # caRNA_Slope_Full_list<-caRNA_Slope_bio_V0.01_BT50_rep1000
  # var_trend_n=Prior_TV_bio_V0.01_BT50_rep1000_M1.05_imp$var_est_n
  # var_trend_g=Prior_TV_bio_V0.01_BT50_rep1000_M1.05_imp$var_est_g
  # sd_coeff<-M1.05
  data.mean<-apply(data.raw,1,mean)
...
#############################Load Data V4#######################################
################################################################################
load("Nondyn_active_temp_BT50_parV_rep1000_N_M1.05.RData")
...
caRNA_raw_BT50_parV_rep1000<-cbind(matrix(t(Nondyn_active_temp_BT50_parV_rep1000_N_M1.05[1:93,]),ncol=1),matrix(t(Nondyn_active_temp_BT50_parV_rep1000_N_M1.05[94:186,]),ncol=1))
caRNA_raw_BT50_parV_rep1000.mean<-apply(caRNA_raw_BT50_parV_rep1000,1,mean)

caRNA_raw_bio_V0.01_BT50_rep1000<-cbind(matrix(t(Nondyn_bio_V0.01_BT50_rep1000_M1.05[,1:104]),ncol=1),matrix(t(Nondyn_bio_V0.01_BT50_rep1000_M1.05[,105:208]),ncol=1))
...
################ggplot density
################only para vary
slope_ind<-round(2*1.414*(50)^0.5)
if(slope_ind>60) slope_ind<-60
if(slope_ind<1) slope_ind<-1
...
ggplot(df_MAP) + geom_point(aes(x1, x2, color = density),size = 1) + scale_color_viridis()+
  ...
  theme(axis.text.x=element_text(size=rel(1.8),face="bold"),axis.text.y=element_text(size=rel(1.5),face="bold"),
        axis.title=element_text(size=rel(2),face="bold"),legend.text=element_text(size=rel(1.5)),
        legend.title =element_text(size=rel(1.5)),plot.margin = unit(c(1,1,1,1), "cm"))  +
  ggsave("Slope_estimation_BT50_parV_rep1000_density_M1.05up.pdf",width=8,height=6)
################all noise
x1<-slope_list_GT[slope_ind,]
...
ggplot(df_MAP) + geom_point(aes(x1, x2, color = density),size = 1) + scale_color_viridis()+
  ...
  theme(axis.text.x=element_text(size=rel(1.8),face="bold"),axis.text.y=element_text(size=rel(1.5),face="bold"),
        axis.title=element_text(size=rel(2),face="bold"),legend.text=element_text(size=rel(1.5)),
        legend.title =element_text(size=rel(1.5)),plot.margin = unit(c(1,1,1,1), "cm"))  +
  ggsave("Slope_estimation_bio_V0.01_BT50_rep1000_density_M1.05up.pdf",width=8,height=6)
####################################################################
#######################################Variance Estimation############################
#####################################all parameters###############################
Prior_Con_bio_V0.01_BT50_rep1000_M1.05up<-Prior_Con_estimate(caRNA_raw_bio_V0.01_BT50_rep1000)
save(Prior_Con_bio_V0.01_BT50_rep1000_M1.05up,file = "Prior_Con_bio_V0.01_BT50_rep1000_M1.05up.RData")

Prior_TV_bio_V0.01_BT50_rep1000_M1.05up<-Prior_TV_estimate(caRNA_raw_bio_V0.01_BT50_rep1000,caRNA_Slope_bio_V0.01_BT50_rep1000)
save(Prior_TV_bio_V0.01_BT50_rep1000_M1.05up,file = "Prior_TV_bio_V0.01_BT50_rep1000_M1.05up.RData")
########################################
plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_BT50_rep1000_M1.05,estimated_var=Prior_TV_bio_V0.01_BT50_rep1000_M1.05up,
             plot_name="Prior_TV_estimate_all_bio_V0.01_BT50_rep1000_M1.05up" )

plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_BT50_rep1000_M1.05,estimated_var=Prior_Con_bio_V0.01_BT50_rep1000_M1.05up,
             plot_name="Prior_Con_estimate_all_bio_V0.01_BT50_rep1000_M1.05up" )
########################################
MAP_TV_bio_V0.01_BT50_rep1000_M1.05up<-MAP_TV_estimate(caRNA_raw_bio_V0.01_BT50_rep1000,caRNA_Slope_bio_V0.01_BT50_rep1000,var_trend_n=Prior_TV_bio_V0.01_BT50_rep1000_M1.05up$var_est_n,
                                                       var_trend_g=Prior_TV_bio_V0.01_BT50_rep1000_M1.05up$var_est_g,0.01)
save(MAP_TV_bio_V0.01_BT50_rep1000_M1.05up,file = "MAP_TV_bio_V0.01_BT50_rep1000_M1.05up.RData")

MAP_Con_bio_V0.01_BT50_rep1000_M1.05up<-MAP_Con_estimate(caRNA_raw_bio_V0.01_BT50_rep1000,var_trend_n=Prior_Con_bio_V0.01_BT50_rep1000_M1.05up$var_est_n,
                                                         var_trend_g=Prior_Con_bio_V0.01_BT50_rep1000_M1.05up$var_est_g,0.01)
save(MAP_Con_bio_V0.01_BT50_rep1000_M1.05up,file = "MAP_Con_bio_V0.01_BT50_rep1000_M1.05up.RData")

MLE_TV_bio_V0.01_BT50_rep1000_M1.05up<-MLE_TV_estimate(caRNA_raw_bio_V0.01_BT50_rep1000,caRNA_Slope_bio_V0.01_BT50_rep1000)
save(MLE_TV_bio_V0.01_BT50_rep1000_M1.05up,file = "MLE_TV_bio_V0.01_BT50_rep1000_M1.05up.RData")
MLE_Con_bio_V0.01_BT50_rep1000_M1.05up<-MLE_Con_estimate(caRNA_raw_bio_V0.01_BT50_rep1000)
save(MLE_Con_bio_V0.01_BT50_rep1000_M1.05up,file = "MLE_Con_bio_V0.01_BT50_rep1000_M1.05up.RData")
################################################################################################################
########################################pure parameter vary########################################################
################################################################################################################
Prior_TV_BT50_parV_rep1000_M1.05up<-Prior_TV_estimate(caRNA_raw_BT50_parV_rep1000,caRNA_Slope_BT50_parV_rep1000)
save(Prior_TV_BT50_parV_rep1000_M1.05up,file = "Prior_TV_BT50_parV_rep1000_M1.05up.RData")
Prior_Con_BT50_parV_rep1000_M1.05up<-Prior_Con_estimate(caRNA_raw_BT50_parV_rep1000)
save(Prior_Con_BT50_parV_rep1000_M1.05up,file = "Prior_Con_BT50_parV_rep1000_M1.05up.RData")

MLE_TV_BT50_parV_rep1000_M1.05up<-MLE_TV_estimate(caRNA_raw_BT50_parV_rep1000,caRNA_Slope_BT50_parV_rep1000)
save(MLE_TV_BT50_parV_rep1000_M1.05up,file = "MLE_TV_BT50_parV_rep1000_M1.05up.RData")
MLE_Con_BT50_parV_rep1000_M1.05up<-MLE_Con_estimate(caRNA_raw_BT50_parV_rep1000)
save(MLE_Con_BT50_parV_rep1000_M1.05up,file = "MLE_Con_BT50_parV_rep1000_M1.05up.RData")

MAP_TV_BT50_parV_rep1000_M1.05up<-MAP_TV_estimate(caRNA_raw_BT50_parV_rep1000,caRNA_Slope_BT50_parV_rep1000,var_trend_n=Prior_TV_BT50_parV_rep1000_M1.05up$var_est_n,
                                                  var_trend_g=Prior_TV_BT50_parV_rep1000_M1.05up$var_est_g, 0.01)
save(MAP_TV_BT50_parV_rep1000_M1.05up,file = "MAP_TV_BT50_parV_rep1000_M1.05up.RData")
MAP_Con_BT50_parV_rep1000_M1.05up<-MAP_Con_estimate(caRNA_raw_BT50_parV_rep1000,var_trend_n=Prior_Con_BT50_parV_rep1000_M1.05up$var_est_n,
                                                    var_trend_g=Prior_Con_BT50_parV_rep1000_M1.05up$var_est_g, 0.01)
save(MAP_Con_BT50_parV_rep1000_M1.05up,file = "MAP_Con_BT50_parV_rep1000_M1.05up.RData")
#############################################################################################
#############################################################################################
# load("MLE_TV_BT50_parV_rep1000_M1.05up.RData")
# load("MLE_Con_BT50_parV_rep1000_M1.05up.RData")
# 
# load("Prior_TV_BT50_parV_rep1000_M1.05up.RData")
# load("Prior_Con_BT50_parV_rep1000_M1.05up.RData")
# 
# load("MAP_TV_BT50_parV_rep1000_M1.05up.RData")
# load("MAP_Con_BT50_parV_rep1000_M1.05up.RData")
# 
# load("MLE_TV_bio_V0.01_BT50_rep1000_M1.05up.RData")
# load("MLE_Con_bio_V0.01_BT50_rep1000_M1.05up.RData")
# 
# load("Prior_TV_bio_V0.01_BT50_rep1000_M1.05up.RData")
# load("Prior_Con_bio_V0.01_BT50_rep1000_M1.05up.RData")
# 
# load("MAP_TV_bio_V0.01_BT50_rep1000_M1.05up.RData")
# load("MAP_Con_bio_V0.01_BT50_rep1000_M1.05up.RData")
#################################
#################Plot#################
##################################
###########################Para only Biology
plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_BT50_rep1000_M1.05,estimated_var=MLE_TV_BT50_parV_rep1000_M1.05up,
             plot_name="MLE_TV_estimate_pure_bio_V0.01_BT50_rep1000_M1.05up" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_BT50_rep1000_M1.05,estimated_var=MLE_Con_BT50_parV_rep1000_M1.05up,
             plot_name="MLE_Con_estimate_pure_bio_V0.01_BT50_rep1000_M1.05up" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_BT50_rep1000_M1.05,estimated_var=Prior_TV_BT50_parV_rep1000_M1.05up,
             plot_name="Prior_TV_estimate_pure_bio_V0.01_BT50_rep1000_M1.05up" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_BT50_rep1000_M1.05,estimated_var=Prior_Con_BT50_parV_rep1000_M1.05up,
             plot_name="Prior_Con_estimate_pure_bio_V0.01_BT50_rep1000_M1.05up" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_BT50_rep1000_M1.05,estimated_var=MAP_TV_BT50_parV_rep1000_M1.05up,
             plot_name="MAP_TV_estimate_pure_bio_V0.01_BT50_rep1000_M1.05up" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_BT50_rep1000_M1.05,estimated_var=MAP_Con_BT50_parV_rep1000_M1.05up,
             plot_name="MAP_Con_estimate_pure_bio_V0.01_BT50_rep1000_M1.05up" )
###########################All Biology
plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_BT50_rep1000_M1.05,estimated_var=MLE_TV_bio_V0.01_BT50_rep1000_M1.05up,
             plot_name="MLE_TV_estimate_all_bio_V0.01_BT50_rep1000_M1.05up" )

plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_BT50_rep1000_M1.05,estimated_var=MLE_Con_bio_V0.01_BT50_rep1000_M1.05up,
             plot_name="MLE_Con_estimate_all_bio_V0.01_BT50_rep1000_M1.05up" )
...
plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_BT50_rep1000_M1.05,estimated_var=MAP_TV_bio_V0.01_BT50_rep1000_M1.05up,
             plot_name="MAP_TV_estimate_all_bio_V0.01_BT50_rep1000_M1.05up" )

plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_BT50_rep1000_M1.05,estimated_var=MAP_Con_bio_V0.01_BT50_rep1000_M1.05up,
             plot_name="MAP_Con_estimate_all_bio_V0.01_BT50_rep1000_M1.05up" )
