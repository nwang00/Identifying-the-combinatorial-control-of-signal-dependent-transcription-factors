...
Prior_TV_estimate<-function(data.raw,caRNA_Slope_Full_list){
  # data.raw<-caRNA_raw_bio_V0.01_B5T5_rep1000
...
MAP_TV_estimate<-function(data.raw,caRNA_Slope_Full_list,var_trend_g,var_trend_n,sd_coeff){
  # data.raw<-caRNA_raw_bio_V0.01_B5T5_rep1000
  # caRNA_Slope_Full_list<-caRNA_Slope_bio_V0.01_B5T5_rep1000
  # var_trend_n=Prior_TV_bio_V0.01_B5T5_rep1000_0.02_imp$var_est_n
  # var_trend_g=Prior_TV_bio_V0.01_B5T5_rep1000_0.02_imp$var_est_g
  # sd_coeff<-0.01
  data.mean<-apply(data.raw,1,mean)
...
#############################Load Data V4#######################################
################################################################################
load("Nondyn_active_temp_B5T5_parV_rep1000_N_M1_2.RData")
load("Nondyn_bio_V0.01_B5T5_rep1000_M1_2.RData")

load("Nondyn_active_GT.RData")
load("slope_list_GT.RData")

caRNA_raw_B5T5_parV_rep1000<-cbind(matrix(t(Nondyn_active_temp_B5T5_parV_rep1000_N_M1_2[1:93,]),ncol=1),matrix(t(Nondyn_active_temp_B5T5_parV_rep1000_N_M1_2[94:186,]),ncol=1))
caRNA_raw_B5T5_parV_rep1000.mean<-apply(caRNA_raw_B5T5_parV_rep1000,1,mean)

caRNA_raw_bio_V0.01_B5T5_rep1000<-cbind(matrix(t(Nondyn_bio_V0.01_B5T5_rep1000_M1_2[,1:104]),ncol=1),matrix(t(Nondyn_bio_V0.01_B5T5_rep1000_M1_2[,105:208]),ncol=1))
...
save(caRNA_Slope_B5T5_parV_rep1000,file="caRNA_Slope_B5T5_parV_rep1000_M1_2_imp.RData")
save(caRNA_Slope_bio_V0.01_B5T5_rep1000,file="caRNA_Slope_bio_V0.01_B5T5_rep1000_M1_2_imp.RData")
# load("caRNA_Slope_B5T5_parV_rep1000.RData")
# load("caRNA_Slope_bio_V0.01_B5T5_rep1000.RData")
################ggplot density
################only para vary
deltaN<-(1/2)
...
ggplot(df_MAP) + geom_point(aes(x1, x2, color = density),size = 1) + scale_color_viridis()+
  ...
  theme(axis.text.x=element_text(size=rel(1.8),face="bold"),axis.text.y=element_text(size=rel(1.5),face="bold"),
        axis.title=element_text(size=rel(2),face="bold"),legend.text=element_text(size=rel(1.5)),
        legend.title =element_text(size=rel(1.5)),plot.margin = unit(c(1,1,1,1), "cm"))  +
  ggsave("Slope_estimation_B5T5_parV_rep1000_density_M1_2_imp.pdf",width=8,height=6)
################all noise
x1<-slope_list_GT[slope_ind,]
...
ggplot(df_MAP) + geom_point(aes(x1, x2, color = density),size = 1) + scale_color_viridis()+
  ...
  theme(axis.text.x=element_text(size=rel(1.8),face="bold"),axis.text.y=element_text(size=rel(1.5),face="bold"),
        axis.title=element_text(size=rel(2),face="bold"),legend.text=element_text(size=rel(1.5)),
        legend.title =element_text(size=rel(1.5)),plot.margin = unit(c(1,1,1,1), "cm"))  +
  ggsave("Slope_estimation_bio_V0.01_B5T5_rep1000_density_M1_2_imp.pdf",width=8,height=6)
####################################################################
#######################################Variance Estimation############################
#####################################all parameters###############################
Prior_TV_bio_V0.01_B5T5_rep1000_M1_2_imp<-Prior_TV_estimate(caRNA_raw_bio_V0.01_B5T5_rep1000,caRNA_Slope_bio_V0.01_B5T5_rep1000)
save(Prior_TV_bio_V0.01_B5T5_rep1000_M1_2_imp,file = "Prior_TV_bio_V0.01_B5T5_rep1000_M1_2_imp.RData")
Prior_Con_bio_V0.01_B5T5_rep1000_M1_2_imp<-Prior_Con_estimate(caRNA_raw_bio_V0.01_B5T5_rep1000)
save(Prior_Con_bio_V0.01_B5T5_rep1000_M1_2_imp,file = "Prior_Con_bio_V0.01_B5T5_rep1000_M1_2_imp.RData")

MAP_TV_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp<-MAP_TV_estimate(caRNA_raw_bio_V0.01_B5T5_rep1000,caRNA_Slope_bio_V0.01_B5T5_rep1000,var_trend_n=Prior_TV_bio_V0.01_B5T5_rep1000_M1_2_imp$var_est_n,
                                                             var_trend_g=Prior_TV_bio_V0.01_B5T5_rep1000_M1_2_imp$var_est_g,0.01)
save(MAP_TV_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp,file = "MAP_TV_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp.RData")
MAP_Con_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp<-MAP_Con_estimate(caRNA_raw_bio_V0.01_B5T5_rep1000,var_trend_n=Prior_Con_bio_V0.01_B5T5_rep1000_M1_2_imp$var_est_n,
                                                               var_trend_g=Prior_Con_bio_V0.01_B5T5_rep1000_M1_2_imp$var_est_g,0.01)
save(MAP_Con_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp,file = "MAP_Con_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp.RData")

MLE_TV_bio_V0.01_B5T5_rep1000_M1_2_imp<-MLE_TV_estimate(caRNA_raw_bio_V0.01_B5T5_rep1000,caRNA_Slope_bio_V0.01_B5T5_rep1000)
save(MLE_TV_bio_V0.01_B5T5_rep1000_M1_2_imp,file = "MLE_TV_bio_V0.01_B5T5_rep1000_M1_2_imp.RData")
MLE_Con_bio_V0.01_B5T5_rep1000_M1_2_imp<-MLE_Con_estimate(caRNA_raw_bio_V0.01_B5T5_rep1000)
save(MLE_Con_bio_V0.01_B5T5_rep1000_M1_2_imp,file = "MLE_Con_bio_V0.01_B5T5_rep1000_M1_2_imp.RData")
################################################################################################################
########################################pure parameter vary########################################################
################################################################################################################
Prior_TV_B5T5_parV_rep1000_M1_2_imp<-Prior_TV_estimate(caRNA_raw_B5T5_parV_rep1000,caRNA_Slope_B5T5_parV_rep1000)
save(Prior_TV_B5T5_parV_rep1000_M1_2_imp,file = "Prior_TV_B5T5_parV_rep1000_M1_2_imp.RData")
Prior_Con_B5T5_parV_rep1000_M1_2_imp<-Prior_Con_estimate(caRNA_raw_B5T5_parV_rep1000)
save(Prior_Con_B5T5_parV_rep1000_M1_2_imp,file = "Prior_Con_B5T5_parV_rep1000_M1_2_imp.RData")

MLE_TV_B5T5_parV_rep1000_M1_2_imp<-MLE_TV_estimate(caRNA_raw_B5T5_parV_rep1000,caRNA_Slope_B5T5_parV_rep1000)
save(MLE_TV_B5T5_parV_rep1000_M1_2_imp,file = "MLE_TV_B5T5_parV_rep1000_M1_2_imp.RData")
MLE_Con_B5T5_parV_rep1000_M1_2_imp<-MLE_Con_estimate(caRNA_raw_B5T5_parV_rep1000)
save(MLE_Con_B5T5_parV_rep1000_M1_2_imp,file = "MLE_Con_B5T5_parV_rep1000_M1_2_imp.RData")

MAP_TV_B5T5_parV_rep1000_0.01_M1_2_imp<-MAP_TV_estimate(caRNA_raw_B5T5_parV_rep1000,caRNA_Slope_B5T5_parV_rep1000,var_trend_n=Prior_TV_B5T5_parV_rep1000_M1_2_imp$var_est_n,
                                                        var_trend_g=Prior_TV_B5T5_parV_rep1000_M1_2_imp$var_est_g, 0.01)
save(MAP_TV_B5T5_parV_rep1000_0.01_M1_2_imp,file = "MAP_TV_B5T5_parV_rep1000_0.01_M1_2_imp.RData")
MAP_Con_B5T5_parV_rep1000_0.01_M1_2_imp<-MAP_Con_estimate(caRNA_raw_B5T5_parV_rep1000,var_trend_n=Prior_Con_B5T5_parV_rep1000_M1_2_imp$var_est_n,
                                                          var_trend_g=Prior_Con_B5T5_parV_rep1000_M1_2_imp$var_est_g, 0.01)
save(MAP_Con_B5T5_parV_rep1000_0.01_M1_2_imp,file = "MAP_Con_B5T5_parV_rep1000_0.01_M1_2_imp.RData")
#############################################################################################
#############################################################################################
load("MLE_TV_B5T5_parV_rep1000_M1_2_imp.RData")
load("MLE_Con_B5T5_parV_rep1000_M1_2_imp.RData")

load("Prior_TV_B5T5_parV_rep1000_M1_2_imp.RData")
load("Prior_Con_B5T5_parV_rep1000_M1_2_imp.RData")

load("MAP_TV_B5T5_parV_rep1000_0.01_M1_2_imp.RData")
load("MAP_Con_B5T5_parV_rep1000_0.01_M1_2_imp.RData")

load("MLE_TV_bio_V0.01_B5T5_rep1000_M1_2_imp.RData")
load("MLE_Con_bio_V0.01_B5T5_rep1000_M1_2_imp.RData")

load("Prior_TV_bio_V0.01_B5T5_rep1000_M1_2_imp.RData")
load("Prior_Con_bio_V0.01_B5T5_rep1000_M1_2_imp.RData")

load("MAP_TV_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp.RData")
load("MAP_Con_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp.RData")
#################################
#################Plot#################
##################################
load("var_empirical_pure_bio_V0.01_B5T5_rep1000_M1_2.RData")
load("var_empirical_bio_V0.01_B5T5_rep1000_M1_2.RData")
###########################Para only Biology
plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=MLE_TV_B5T5_parV_rep1000_M1_2_imp,
             plot_name="MLE_TV_estimate_pure_bio_V0.01_B5T5_rep1000_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=MLE_Con_B5T5_parV_rep1000_M1_2_imp,
             plot_name="MLE_Con_estimate_pure_bio_V0.01_B5T5_rep1000_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=Prior_TV_B5T5_parV_rep1000_M1_2_imp,
             plot_name="Prior_TV_estimate_pure_bio_V0.01_B5T5_rep1000_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=Prior_Con_B5T5_parV_rep1000_M1_2_imp,
             plot_name="Prior_Con_estimate_pure_bio_V0.01_B5T5_rep1000_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=MAP_TV_B5T5_parV_rep1000_0.01_M1_2_imp,
             plot_name="MAP_TV_estimate_pure_bio_V0.01_B5T5_rep1000_std0.01_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_pure_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=MAP_Con_B5T5_parV_rep1000_0.01_M1_2_imp,
             plot_name="MAP_Con_estimate_pure_bio_V0.01_B5T5_rep1000_std0.01_M1_2_imp" )
###########################All Biology
plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=MLE_TV_bio_V0.01_B5T5_rep1000_M1_2_imp,
             plot_name="MLE_TV_estimate_all_bio_V0.01_B5T5_rep1000_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=MLE_Con_bio_V0.01_B5T5_rep1000_M1_2_imp,
             plot_name="MLE_Con_estimate_all_bio_V0.01_B5T5_rep1000_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=Prior_TV_bio_V0.01_B5T5_rep1000_M1_2_imp,
             plot_name="Prior_TV_estimate_all_bio_V0.01_B5T5_rep1000_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=Prior_Con_bio_V0.01_B5T5_rep1000_M1_2_imp,
             plot_name="Prior_Con_estimate_all_bio_V0.01_B5T5_rep1000_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=MAP_TV_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp,
             plot_name="MAP_TV_estimate_all_bio_V0.01_B5T5_rep1000_std0.01_M1_2_imp" )

plot_heatmap(ground_truth_var=var_empirical_bio_V0.01_B5T5_rep1000_M1_2,estimated_var=MAP_Con_bio_V0.01_B5T5_rep1000_0.01_M1_2_imp,
             plot_name="MAP_Con_estimate_all_bio_V0.01_B5T5_rep1000_std0.01_M1_2_imp" )
